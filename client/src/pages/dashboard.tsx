...
import { Users, BarChart3, Server, Download, RefreshCw } from "lucide-react";
...
// ⬇️ NEW: import Automation + ReactFlowProvider
import AutomationBuilder from "@/components/automation/AutomationBuilder";
import { ReactFlowProvider } from "reactflow";

type ActiveTab = "tasks" | "profiles" | "settings" | "automation"; // ⬅️ NEW
    ...
    <div className="flex h-screen bg-neutral-50">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <main className="flex-1 flex overflow-hidden">
          ...
          {/* ⬇️ NEW: tab Automation */}
          {activeTab === "automation" && (
  <div className="flex-1 min-h-0">  {/* đảm bảo con có thể cao > 0 */}
    <ReactFlowProvider>
      <AutomationBuilder />
    </ReactFlowProvider>
  </div>
