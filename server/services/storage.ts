...
export interface IStorage {
  ...
  updateProfile(id: number, updates: Partial<InsertProfile> & { lastUsed?: Date }): Promise<Profile | undefined>;
...
export class MemStorage implements IStorage {
  ...
  async updateTask(id: number, updates: Partial<InsertTask> & { request?: any; response?: any }): Promise<Task | undefined> {
    ...
    const updatedTask = { ...task, ...updates, lastUpdated: new Date() };
  ...
  async updateProfile(id: number, updates: Partial<InsertProfile> & { lastUsed?: Date }): Promise<Profile | undefined> {
