...
const extractedData = await act.getText(page, "//*[@id=\"__next\"]/div[1]/div/div[2]/div[2]/div[1]/div/div/div[1]/main/article/div/div/div[1]/div[1]");
...
const aiResponse = await (async () => {
  ...
  // Using input from variable: data
  const userPrompt = `Comment on this: ${data}`;
